...
export const orderService = {
    ...
    try {
      ...
      if ('Notification' in window && Notification.permission === 'granted') {
        new Notification('Order Placed Successfully!', {
          body: `Your order worth TND${orderData.total.toFixed(2)} has been placed`,
          icon: '/favicon.ico',
  ...
  body: `Your order #${order.id.slice(-8)} worth TND${order.total.toFixed(2)} has been confirmed`,
        icon: '/favicon.ico',
